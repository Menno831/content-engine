            ...
            {state.ok && state.password ? (
              <div className="space-y-4">
                ...
                <div className="rounded-xl border border-white/[0.08] bg-white/[0.02] p-4 space-y-3">
                  ...
                  <p className="text-[11px] text-muted">Inloggen via /login op deze site.</p>
                </div>
                <button onClick={() => setOpen(false)} className="w-full rounded-xl bg-accent hover:bg-accent-hover text-background font-bold text-sm py-2.5 transition-colors">Klaar</button>
              </div>
            ) : (
