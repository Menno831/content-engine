...
create table if not exists competitor_posts (
  ...
  fetched_at    timestamptz not null default now(),
  fit           boolean,                -- past bij de strategie (AI-oordeel)
  fit_reason    text,
  fit_angle     text,                   -- hoe Menno dit zou maken
...
create table if not exists content_ideas (
  ...
  source_url  text,                             -- directe link (bv. Discover-post)
