...
drop table if exists
  ad_insights, ad_entries, scripts, seen_invoices, account_metrics, brief_ideas, competitor_posts, competitors, transcripts, orders, captures, generations, prospects, content_metrics, leads, content,
...
-- ── Advertenties op campagne-niveau ─────────────────────────────
