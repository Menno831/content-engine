...
<section class="doc">
  ...
  <div class="cards">
    ...
    <div class="card">
      ...
      <p>Uit elke draai knippen we tot 30 korte verticale video's voor je clip-accounts, plus een trailer voor je
      eigen kanaal. E&eacute;n keer draaien, maanden aan content.</p>
    </div>
  </div>
</section>
...
<section class="doc">
  ...
  <div class="step"><div class="n">2</div><div>
    ...
    verhaal dient. Zo heb ik eerder de documentaires voor FunX gedraaid. Dit is het verschil tussen een
    videograaf inhuren en een film laten maken.</p></div></div>
  ...
  <div class="step"><div class="n">4</div><div>
    ...
    Strak, niet overgeproduceerd. E&eacute;n volledige feedbackronde zit erin, kleine fixes doen we gewoon.</p></div></div>
  <div class="step"><div class="n">5</div><div>
    ...
    hoofdvideo &eacute;n alle reels: nemen wij volledig uit handen. Jij hoeft niks te doen.</p></div></div>
</section>
...
<section class="doc">
  ...
  <div class="vgrid">
    ...
    <div class="vcard"><h3>De juiste mensen, niet de meeste</h3>
      <p>Dit gaat niet om views. Het gaat om talent dat bij je wil werken, partners die aanhaken, en klanten die
      Flaneur echt snappen. We optimaliseren voor jouw mensen, niet voor cijfers.</p></div>
...
<section class="doc">
  ...
  <div class="price">
    ...
    <div class="pc reco">
      ...
      <div class="addon"><span>Dubai-productie, afroep</span><span class="amt">+ &euro;4.500</span></div>
      <div class="addon"><span>Istanbul-productie, afroep</span><span class="amt">+ &euro;2.500</span></div>
    </div>
  </div>

  <div class="sum"><strong>De rekensom:</strong> los koop je twee video's voor &euro;17.500. In de engine krijg je
  over zes maanden zes volledige video's, waaronder beide documentaires, plus tot 180 verticale clips, voor
  &euro;29.500 totaal. Dat is minder dan &euro;5.000 per video in plaats van &euro;8.750. En je betaalt per maand
  minder dan wat je eerder kwijt was aan alleen short-form, terwijl wij nu een complete contentrol overnemen,
  van strategie tot en met upload.</div>
  ...
  <p>En die supplier-reels die je al hebt liggen? Die heb je van me. Zie het als voorproefje van het niveau.</p>

  <div class="flow"><strong>Volgende stap:</strong> zeg gewoon ja, dan prikken we de draaidagen. Istanbul kan al
  snel, Dubai zetten we vast voor de eerste helft van november. Dan zijn we ruim op tijd voor Black Friday.</div>
  ...
  maanden. E&eacute;n volledige revisieronde per hoofdvideo inbegrepen. Dronebeelden in de fabriek in Istanbul kunnen
