...
.pc .losnote{margin:12px 0 0;font-size:12.5px;color:var(--muted);line-height:1.55}
...
<section class="doc">
  ...
  <div class="step"><div class="n">5</div><div>
    ...
    hoofdvideo &eacute;n alle reels: nemen wij volledig uit handen. Jij hoeft niks te doen. <strong>Deze volledige
    push zit in de engine;</strong> ga je voor een losse productie, dan leveren we alles kant-en-klaar aan en doe
    je het plaatsen zelf.</p>
...
<section class="doc">
  ...
  crew, volledige edit, cutdowns en trailer. E&eacute;n bedrag, geen bonnetjes achteraf, geen verrassingen. De
  prijs staat vast, ook als tickets of hotels duurder uitvallen. Dat risico is voor mij.</div>
  ...
  <div class="price">
    <div class="pc">
      ...
      <p class="losnote">Je krijgt de film, de clips en de trailer kant-en-klaar aangeleverd, inclusief thumbnail
      en titel. Het plaatsen, A/B-testen en optimaliseren doe je dan zelf.</p>
    </div>
    <div class="pc reco">
      ...
      <p>Elke maand een volledige founder-video plus cutdowns, &eacute;n <strong>de volledige push</strong>: drie
      thumbnails en drie titels per video, A/B-getest tot de winnaar staat, SEO, plaatsen en optimaliseren van
      alles. Jij hoeft letterlijk alleen voor de camera te staan. E&eacute;n draaidag in Nederland per maand
      inbegrepen.</p>
      <p>Wil je die maand een van de grote documentaires draaien, dan komt er een vaste meerprijs bij die de hele
      productie en reis dekt. Die documentaire is dan je video voor die maand, alles inbegrepen: twee man crew,
      vluchten, hotel, de complete productie op alle locaties.</p>
      <div class="addon"><span>Founder-documentaire (Dubai + Amsterdam), afroep</span><span class="amt">+ &euro;5.000</span></div>
      <div class="addon"><span>Made in Istanbul, afroep</span><span class="amt">+ &euro;3.000</span></div>
